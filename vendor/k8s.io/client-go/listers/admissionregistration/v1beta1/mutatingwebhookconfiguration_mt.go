...
func (s *mutatingWebhookConfigurationLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *mutatingWebhookConfigurationLister) Get(name string) (*v1beta1.MutatingWebhookConfiguration, error) {
	if s.tenant == nil {
		...
		debug.PrintStack()
		return nil, fmt.Errorf("cannot get mutatingwebhookconfiguration w/o specifying tenant")
	}
