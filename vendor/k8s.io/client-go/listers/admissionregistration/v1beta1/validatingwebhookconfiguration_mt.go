...
func (s *validatingWebhookConfigurationLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *validatingWebhookConfigurationLister) Get(name string) (*v1beta1.ValidatingWebhookConfiguration, error) {
	if s.tenant == nil {
		...
		debug.PrintStack()
		return nil, fmt.Errorf("cannot get validatingwebhookconfiguration w/o specifying tenant")
	}
