...
func (s *statefulSetLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *statefulSetLister) StatefulSets(namespace string) StatefulSetNamespaceLister {
	return statefulSetNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
