...
func (s *endpointsLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *endpointsLister) Endpoints(namespace string) EndpointsNamespaceLister {
	return endpointsNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
