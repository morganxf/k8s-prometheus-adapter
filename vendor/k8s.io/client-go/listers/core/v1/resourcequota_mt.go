...
func (s *resourceQuotaLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *resourceQuotaLister) ResourceQuotas(namespace string) ResourceQuotaNamespaceLister {
	return resourceQuotaNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
