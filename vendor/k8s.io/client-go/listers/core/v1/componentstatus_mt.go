...
func (s *componentStatusLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *componentStatusLister) Get(name string) (*v1.ComponentStatus, error) {
	if s.tenant == nil {
		...
		debug.PrintStack()
		return nil, fmt.Errorf("cannot get componentstatus w/o specifying tenant")
	}
