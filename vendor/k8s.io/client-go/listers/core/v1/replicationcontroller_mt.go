...
func (s *replicationControllerLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *replicationControllerLister) ReplicationControllers(namespace string) ReplicationControllerNamespaceLister {
	return replicationControllerNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
