...
func (s *secretLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
	return &secretLister{
		indexer: s.indexer,
		tenant:  tenant,
	}
...
func (s *secretLister) Secrets(namespace string) SecretNamespaceLister {
	return secretNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
