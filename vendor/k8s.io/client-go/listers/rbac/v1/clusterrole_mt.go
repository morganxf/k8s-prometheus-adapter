...
func (s *clusterRoleLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *clusterRoleLister) Get(name string) (*v1.ClusterRole, error) {
	if s.tenant == nil {
		...
		debug.PrintStack()
		return nil, fmt.Errorf("cannot get clusterrole w/o specifying tenant")
	}
