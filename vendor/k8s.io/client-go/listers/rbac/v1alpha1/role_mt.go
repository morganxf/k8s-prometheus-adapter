...
func (s *roleLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
	return &roleLister{
		indexer: s.indexer,
		tenant:  tenant,
	}
...
func (s *roleLister) Roles(namespace string) RoleNamespaceLister {
	return roleNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
