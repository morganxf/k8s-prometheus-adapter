...
func (s *priorityClassLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *priorityClassLister) Get(name string) (*v1beta1.PriorityClass, error) {
	if s.tenant == nil {
		...
		debug.PrintStack()
		return nil, fmt.Errorf("cannot get priorityclass w/o specifying tenant")
	}
