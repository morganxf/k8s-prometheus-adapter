...
func (s *certificateSigningRequestLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *certificateSigningRequestLister) Get(name string) (*v1beta1.CertificateSigningRequest, error) {
	if s.tenant == nil {
		...
		debug.PrintStack()
		return nil, fmt.Errorf("cannot get certificatesigningrequest w/o specifying tenant")
	}
