...
func (s *podPresetLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *podPresetLister) PodPresets(namespace string) PodPresetNamespaceLister {
	return podPresetNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
